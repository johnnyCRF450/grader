...
CRITICAL: This is a THEORETICAL assignment — students describe what WOULD happen in writing.
Credit students for describing expected/predicted outcomes; do not penalize for lack of actual computed results.
{rl_examples}
{context}""",
        messages=[
            {
