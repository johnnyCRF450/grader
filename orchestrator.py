"""
Orchestrator — coordinates the 7-agent grading pipeline for Assignment 1.4.
...
class GradeReport:
    ...
    def total_possible(self) -> int:
        return self.scores.get("total_possible", 40)
...
def grade(
    ...
    pct = scores['total_points'] / scores['total_possible'] * 100
    print(f"    ✓ Complete — {scores['total_points']}/{scores['total_possible']} ({_letter(pct)})")
    report = GradeReport(
